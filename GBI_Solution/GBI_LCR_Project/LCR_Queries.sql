...
SELECT
    ...
    CASE WHEN F.[Product_Number] IN ('21095','21096')
         THEN 'Yes' ELSE 'No' END                 AS [Is_Product Number_21095_21096_B],
    F.[Product_Number]                            AS [Product Number_B],
    CASE WHEN F.[Product_Number] IN ('23000','23004')
         THEN 'Yes' ELSE 'No' END                 AS [Is_Product Number_23000_23004_B],
    F.[Contract]                                  AS [Contract_B]
FROM raw.[yyy_30_BBVA_Financial_Statement] AS F;
